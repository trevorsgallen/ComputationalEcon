...
%     title('1')
%     subplot(3,3,2)
%     plot(x_space,x_space)
%     title('x')
%     subplot(3,3,3)
%     plot(x_space,x_space.^2)
%     title('x^2')
%     subplot(3,3,4)
%     plot(x_space,x_space.^3)
%     title('x^3')
%     subplot(3,3,5)
%     plot(x_space,x_space.^4)
%     title('x^4')
%     subplot(3,3,6)
%     plot(x_space,x_space.^5)
%     title('x^5')
%     subplot(3,3,7)
%     plot(x_space,x_space.^6)
%     title('x^6')
%     subplot(3,3,8)
%     plot(x_space,x_space.^7)
%     title('x^7')
%     subplot(3,3,9)
%     plot(x_space,x_space.^8)
%     title('x^8')
