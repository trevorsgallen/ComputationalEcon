%Import the data from NIPA (I, delta*K, Y, C)
    clear
    filename = '/Users/tgallen/Dropbox/Econ_641/Fall_2016/Lecture 11 - NCG/Workbook2.csv';
    delimiter = ',';
    startRow = 2;
    formatSpec = '%f%f%f%f%[^\n\r]';
...
%Import the data from BLS (hours and employment)
    [~, ~, raw] = xlsread('/Users/tgallen/Dropbox/Econ_641/Fall_2016/Lecture 11 - NCG/HoursEmployment.xlsx','Sheet1');
...
%% Import the data from BLS (population)
    N_t = xlsread('/Users/tgallen/Dropbox/Econ_641/Fall_2016/Lecture 11 - NCG/Population.xlsx','Sheet1');
    N_t = N_t*1000;
